...
public class KnowledgeBaseServiceImpl implements KnowledgeBaseService {
    ...
    public void update(Long id, KnowledgeBaseUpdateRequest request) {
        ...
        if (kb == null || kb.getDeleted() != null && kb.getDeleted() == 1) {
            throw new BizException(ErrorCode.KNOWLEDGE_BASE_NOT_FOUND, "知识库不存在：" + id);
        }
    ...
    @Override
    public Result<PageResult<KnowledgeBaseResponse>> list(KnowledgeBaseListRequest request) {
